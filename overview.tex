...
implementations with identical behavior, and the effort required to
make differential testing actually useful seems overwhelming.  While
...
cannot be widely used without advances in differential specification.
